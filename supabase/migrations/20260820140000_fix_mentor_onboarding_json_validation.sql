...
declare
  ...
  required_keys constant text[] := array[
    'full_name', 'preferred_name', 'current_role', 'sector_area', 'work_structure',
    'professional_experience', 'typical_week', 'top_three_activities', 'recurring_dependency',
    'postponed_work', 'desired_work', 'unsolved_problem_consequences', 'attempted_solutions',
    'ai_routine_relief', 'first_capability', 'learn_alone', 'delegate_to_ai', 'why_now',
    'six_months_same_way', 'worthwhile_outcome', 'priority_process', 'process_reason',
    'process_people', 'process_volume', 'process_current_steps', 'process_sources',
    'process_output', 'process_output_use', 'process_time', 'process_repetitive_parts',
    'process_human_judgement', 'process_errors', 'process_approver', 'ideal_ai_help',
    'ai_excluded_responsibility', 'better_process', 'minimum_acceptable_result',
    'urgency_deadline', 'best_ai_result', 'most_frustrating_ai_experience', 'ai_limit',
    'available_tools_licenses', 'company_restrictions', 'ai_approval_policy', 'never_delegate_tasks',
    'human_decisions', 'risky_ai_experience', 'trust_requirements', 'mentor_expectations',
    'point_a', 'point_b', 'important_unasked'
  ];
begin
